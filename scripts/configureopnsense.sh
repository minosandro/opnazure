...
#fetch https://raw.githubusercontent.com/minosandro/opnazure/dev_active_active/scripts/$1
#fetch https://raw.githubusercontent.com/minosandro/opnazure/master/scripts/$1
